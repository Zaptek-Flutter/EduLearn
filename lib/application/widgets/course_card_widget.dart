...
class MyCoursesWidget extends ConsumerStatefulWidget {
  final Course course;

  const MyCoursesWidget({super.key, required this.course});

  @override
  ConsumerState<MyCoursesWidget> createState() => _MyCoursesWidgetState();
}

class _MyCoursesWidgetState extends ConsumerState<MyCoursesWidget> {
